...
articleView.handleAuthorFilter = function() {
  $('#author-filter').on('change', function() {
    ...
    if ($(this).val()) {
      ...
      articleView.clearArticles();
      articleView.displayAuthor($(this).val());
...
articleView.clearArticles = function() {
 $('article.populated').remove();

};

articleView.displayAuthor = function(author) {
...
articleView.handleCategoryFilter = function() {
  ...
  $('#category-filter').on('change', function() {
    articleView.clearArticles();
    articleView.displayCategory($(this).val());
  });
};

articleView.displayCategory = function(cat) {
  articles.forEach(function(a){
    if (a.category == cat) {
...
articleView.handleMainNav = function() {
  ...
  $('.main-nav .tab').on('click', function() {
   ...
   if (content == 'about') {
     ...
     $('article.populated').css('display', 'block');
